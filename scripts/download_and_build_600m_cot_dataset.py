#!/usr/bin/env python3
"""
Hugging Face 600M+ Token CoT Dataset Fetcher for RLF Frontier 24G (Ubuntu Linux)
==================================================================================
Streams and formats 600M+ Tokens (~1.5 Million to 2.0 Million CoT reasoning rows)
...
- UltraChat / Alpaca (Dialogue & general knowledge)

Outputs clean instructions.tsv, dialogues.tsv, and corpus.txt.
Supports .env with HF_TOKEN for gated/private HF repos.
"""
...
def download_file(url: str, dest_path: Path, token: str = None):
    ...
    headers = {"User-Agent": "RLF-Ubuntu-600M-Fetcher/1.0"}
    if token:
    ...
    with open(input_file, "r", encoding="utf-8") as f:
        for line in f:
            ...
            if "####" in raw_answer:
                ...
                rationale = f"<think> Step 1: Analyze mathematical constraints. Step 2: {reasoning_steps} </think>"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="RLF Ubuntu 600M+ Token CoT Dataset Builder")
    parser.add_argument("--output-dir", type=str, default="demo_data/frontier_600m", help="Target dataset directory")
    parser.add_argument("--max-samples", type=int, default=1500000, help="Maximum reasoning samples (default: 1500000)")
    ...
    print("=========================================================================")
    print("  RLF Ubuntu Frontier 24G — 600M+ Token CoT Reasoning Dataset Builder   ")
    print("=========================================================================")
    ...
    print(f"\n=======================================================")
    print(f"[+] Successfully built 600M+ Token CoT dataset:")
